...
static void handle_swap_eth(ethPluginProvideParameter_t *msg, sushiswap_parameters_t *context) {
...
static void handle_swap_tokens(ethPluginProvideParameter_t *msg, sushiswap_parameters_t *context) {
    PRINTF("GPIRIOU msg->offset: %d\n", msg->parameterOffset);
    PRINTF("GPIRIOU next_param: %d, skip: %d\n",
           context->next_param == TOKEN_B_ADDRESS,
           context->skip);
