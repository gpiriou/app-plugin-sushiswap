...
const { NANOS_ETH_ELF_PATH, NANOX_ETH_ELF_PATH, NANOS_SUSHISWAP_LIB, NANOX_LIDO_LIB, sim_options_nanos, sim_options_nanox, TIMEOUT } = require("generic.js");
...
test("Transfer nanos", async () => {
  ...
  const sim = new Zemu(NANOS_ETH_ELF_PATH, NANOS_SUSHISWAP_LIB);
